#!/usr/bin/env bash
# Project #3 board sync after the post-S1 issue close-out sweep.
#
# What this does:
#   1. Reads every item on GitHub Project #3 (owner: facktivist).
...
#
# Origin: post-S1 sweep (commit 03a2cdc5c + 04 batch-close of issues
